...
import 'package:hrm/views/marketing/client_task_detail.dart';
import 'package:hrm/views/marketing/client_visit_screen.dart';
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ClientVisitScreen(),
                  ),
                );
              },
              child: Container(
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ClientTaskDetailScreen(task: task),
                  ),
                );
              },
              child: Row(
