      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.task['project_required'] ?? widget.task['shopName'] ?? "Product Demo - Tech Solutions",
              style: GoogleFonts.poppins(
                fontSize: 15,
            ...
            _buildSection(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    isCheckedIn ? "Checked in at:" : "Ready to start your visit?",
                    style: GoogleFonts.poppins(
                      fontSize: 14,
                    ...
                    onPressed: () {
                      if (!isCheckedIn) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => TaskReportScreen(task: widget.task, checkInTime: checkInTime!),
                          ),
                        );
                      }
                    },
                    icon: Icon(isCheckedIn ? Icons.logout : Icons.exit_to_app, size: 18),
                    label: Text(isCheckedIn ? "Check out & Submit Report" : "Check in to Visit"),
            ...
            _buildSection(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.task['purpose'] ?? widget.task['project_required'] ?? "product demo",
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.task['date'] == null || widget.task['date'] == "null"
            ...
            _buildSection(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _infoField("Name", widget.task['customer_name'] ?? widget.task['shopName'] ?? "Akhil"),
                  _infoField("Company", "Tech Solutions Inc"),
                  _infoField("Phone", "+1234567891"),
                  _infoField("Email", "akhil@techsolutions.com"),
                  const Padding(
                    padding: EdgeInsets.symmetric(vertical: 12),
                    child: Divider(height: 1),
                  ),
