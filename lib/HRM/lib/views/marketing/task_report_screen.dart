      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Complete the report for ${widget.task['customer_name'] ?? widget.task['shopName'] ?? 'Akhil'}",
              style: GoogleFonts.poppins(
                fontSize: 14,
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        _summaryItem("Check-In", widget.checkInTime),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _summaryItem("Client", widget.task['customer_name'] ?? widget.task['shopName'] ?? "Tech Solutions"),
                      ],
                    ),
                  ],
                ),
            ...
            _buildSection(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(_notesController, "Enter meeting notes...", 4),
                  const SizedBox(height: 20),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          hint: Text("Select Purpose of Visit", style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey.shade500)),
          isExpanded: true,
          value: selectedOutcome,
          items: ["Interested", "Follow up", "Not interested", "Completed"].map((e) {
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(Icons.calendar_month_outlined, color: Colors.indigo.shade800, size: 20),
          ],
        ),
      ),
    );
