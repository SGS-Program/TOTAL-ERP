    ...
    try {
      ...
      if (response['error'] == false) {
        ...
        await prefs.setString(
            'login_cus_id', response['cus_id']?.toString() ?? response['data']?['cus_id']?.toString() ?? '');
        await prefs.setString('uid', response['data']?['cus_id']?.toString() ?? '');
        await prefs.setString('cid', response['cid']?.toString() ?? response['data']?['cid']?.toString() ?? '');
        await prefs.setString('cid_str', response['cid']?.toString() ?? response['data']?['cid']?.toString() ?? '');
