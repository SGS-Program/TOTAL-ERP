...
abstract class AppLocalizations {
  ...
  /// No description provided for @manageBiz.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @verifyWithOtp.
  ///
  /// In en, this message translates to:
  /// **'Verify with OTP'**
  ...
  /// No description provided for @smartErp.
  ///
  /// In en, this message translates to:
  /// **'Smart ERP'**
  String get smartErp;

  /// No description provided for @erpDashboard.
  ///
  /// In en, this message translates to:
  /// **'ERP Dashboard'**
  String get erpDashboard;
  ...
  /// No description provided for @workplaceDashboard.
  ///
  /// In en, this message translates to:
  /// **'Workplace Dashboard'**
  String get workplaceDashboard;
